...
DocMeta.setdocmeta!(HadronicLineshapes, :DocTestSetup, :(using HadronicLineshapes); recursive = true)
...
makedocs(;
  ...
  format = Documenter.HTML(; canonical = "https://mmikhasenko.github.io/HadronicLineshapes.jl"),
  pages = [
    "index.md"
    [
      file for
